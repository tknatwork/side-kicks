    ...
    try {
        ...
        switch (command) {
            ...
            case 'create_variable_collection':
                result = await createVariableCollection(payload);
                break;
            case 'create_variable':
                result = await createVariable(payload);
                break;
            case 'set_variable_value':
                result = await setVariableValue(payload);
                break;
            case 'delete_variable':
                result = await deleteVariable(payload);
                break;
            case 'create_mode':
                result = await createMode(payload);
                break;
            // Style Commands
            case 'create_color_style':
                result = await createColorStyle(payload);
                break;
            case 'update_color_style':
                result = await updateColorStyle(payload);
                break;
            case 'create_text_style':
                result = await createTextStyle(payload);
                break;
            case 'update_text_style':
                result = await updateTextStyle(payload);
                break;
            case 'create_effect_style':
                result = await createEffectStyle(payload);
                break;
            case 'update_effect_style':
                result = await updateEffectStyle(payload);
                break;
            case 'create_grid_style':
                result = await createGridStyle(payload);
                break;
            case 'update_grid_style':
                result = await updateGridStyle(payload);
                break;
            case 'delete_style':
                result = await deleteStyle(payload);
                break;
            // Page Commands
            case 'create_page':
            ...
            case 'create_frame':
                ...
                break;
            case 'create_section':
                result = await createSection(payload);
                break;
            case 'create_color_swatches_group':
                await createColorSwatchesGroup(payload);
                result = { message: 'Success' };
                break;
            case 'create_typography_group':
                await createTypographyGroup(payload);
                result = { message: 'Success' };
                break;
            case 'create_effect_group':
                await createEffectGroup(payload);
                result = { message: 'Success' };
                break;
            case 'create_grid_group':
                await createGridGroup(payload);
                result = { message: 'Success' };
                break;
            case 'create_text':
                ...
                break;
            case 'update_text':
                result = await updateText(payload);
                break;
            ...
            case 'create_ellipse':
                ...
                break;
            case 'create_vector':
                result = await createVector(payload);
                break;
            case 'create_line':
                result = await createLine(payload);
                break;
            case 'append_to_frame':
                result = await appendToFrame(payload);
                break;
            case 'apply_effect':
                result = await applyEffect(payload);
                break;
            case 'create_component':
                result = await createComponent(payload);
                break;
            case 'create_component_set':
                result = await createComponentSet(payload);
                break;
            case 'create_instance':
                result = await createInstance(payload);
                break;
            case 'bind_variable':
                result = await bindVariable(payload);
                break;
            case 'set_component_properties':
                result = await setComponentProperties(payload);
                break;
            // Query Commands
            ...
            case 'set_variable_scopes':
                result = await setVariableScopes(payload);
                break;
            case 'set_collection_scopes':
                result = await setCollectionScopes(payload);
                break;
            // Publishing Commands
            case 'hide_collection_from_publishing':
                result = await hideCollectionFromPublishing(payload);
                break;
            case 'rename_collection':
                result = await renameCollection(payload);
                break;
            case 'delete_collection':
                result = await deleteCollection(payload);
                break;
            // Mode Binding Commands
            case 'set_explicit_variable_modes':
                result = await setExplicitVariableModes(payload);
                break;
            case 'get_explicit_variable_modes':
                result = await getExplicitVariableModes(payload);
                break;
            case 'clear_explicit_variable_modes':
                result = await clearExplicitVariableModes(payload);
                break;
            case 'create_mode_switching_frames':
                result = await createModeSwitchingFrames(payload);
                break;
            // Node Query and Move Commands
            case 'get_page_children':
                result = await getPageChildren(payload);
                break;
            case 'get_local_components':
                result = await getLocalComponents();
                break;
            case 'move_node_to_page':
                result = await moveNodeToPage(payload);
                break;
            case 'clone_node_to_page':
                result = await cloneNodeToPage(payload);
                break;
            case 'delete_node':
                result = await deleteNode(payload);
                break;
            case 'clear_page_children':
                result = await clearPageChildren(payload);
                break;
            case 'get_node_info':
                result = await getNodeInfo(payload);
                break;
            case 'set_node_position':
                result = await setNodePosition(payload);
                break;
            case 'append_node_to_frame':
                result = await appendNodeToFrame(payload);
                break;
            case 'resize_node':
                result = await resizeNode(payload);
                break;
            case 'set_auto_layout':
                result = await setAutoLayout(payload);
                break;
            case 'bind_variable_to_node':
                result = await bindVariableToNode(payload);
                break;
            case 'set_node_fills':
                result = await setNodeFills(payload);
                break;
            case 'rename_node':
                result = await renameNode(payload);
                break;
            case 'add_component_description':
                result = await addComponentDescription(payload);
                break;
            // Library Commands
            case 'import_component_by_key':
                result = await importComponentByKey(payload);
                break;
            case 'search_library_components':
                result = await searchLibraryComponents(payload);
                break;
            case 'flatten_node':
                result = await flattenNode(payload);
                break;
            case 'convert_to_component':
                result = await convertToComponent(payload);
                break;
            case 'set_instance_swap_property':
                result = await setInstanceSwapProperty(payload);
                break;
            case 'swap_instance':
                result = await swapInstance(payload);
                break;
            case 'get_available_library_components':
                result = await getAvailableLibraryComponents();
                break;
            case 'batch_import_and_flatten':
                result = await batchImportAndFlatten(payload);
                break;
            // SVG Import Commands
            case 'create_from_svg':
                result = await createFromSvg(payload);
                break;
            case 'batch_create_icons_from_svg':
                result = await batchCreateIconsFromSvg(payload);
                break;
            // Icon Processing Commands (for Temporary page → Icons page)
            case 'process_temp_icons':
                result = await processTempIcons(payload);
                break;
            case 'clone_and_convert_icon':
                result = await cloneAndConvertIcon(payload);
                break;
            case 'batch_move_to_page':
                result = await batchMoveToPage(payload);
                break;
            case 'scan_page_instances':
                result = await scanPageInstances(payload);
                break;
            case 'flatten_and_rename_instances':
                result = await flattenAndRenameInstances(payload);
                break;
            // Deep scan and extract icons from Temporary Icons page
            case 'extract_temp_icons':
                result = await extractTempIcons(payload);
                break;
            case 'extract_single_category':
                result = await extractSingleCategory(payload);
                break;
            case 'get_category_list':
                result = await getCategoryList(payload);
                break;
            case 'get_frame_children':
                result = await getFrameChildren(payload);
                break;
            case 'analyze_page_styles':
                result = await analyzePageStyles(payload);
                break;
            case 'remap_paint_styles':
                result = await remapPaintStyles(payload);
                break;
            case 'remap_text_styles':
                result = await remapTextStyles(payload);
                break;
            case 'remap_effect_styles':
                result = await remapEffectStyles(payload);
                break;
            // Batch variable operations (build-figma-ds.js optimized)
            case 'batch_create_variables':
                result = await batchCreateVariables(payload);
                break;
            case 'batch_set_variable_aliases':
                result = await batchSetVariableAliases(payload);
                break;
            case 'batch_create_styles':
                result = await batchCreateStyles(payload);
                break;
            default:
...
async function createVariableCollection(payload) {
...
async function setVariableValue(payload) {
...
async function deleteVariable(payload) {
    const variable = await figma.variables.getVariableByIdAsync(payload.variableId);
    if (!variable) {
        throw new Error(`Variable not found: ${payload.variableId}`);
    }
...
async function setVariableScopes(payload) {
    const variable = await figma.variables.getVariableByIdAsync(payload.variableId);
    if (!variable) {
        throw new Error(`Variable not found: ${payload.variableId}`);
    }
...
async function setCollectionScopes(payload) {
    const collection = await figma.variables.getVariableCollectionByIdAsync(payload.collectionId);
    if (!collection) {
        throw new Error(`Collection not found: ${payload.collectionId}`);
    }
...
async function createColorStyle(payload) {
    var _a;
    ...
    style.paints = [{
            type: 'SOLID',
            color: payload.color,
            opacity: (_a = payload.opacity) !== null && _a !== void 0 ? _a : 1
        }];
    return {
        id: style.id,
        name: style.name
...
async function createTextStyle(payload) {
...
async function updateTextStyle(payload) {
...
async function createEffectStyle(payload) {
...
async function updateEffectStyle(payload) {
...
async function createGridStyle(payload) {
    ...
    style.layoutGrids = payload.layoutGrids.map(grid => {
        ...
        if (grid.pattern === 'GRID') {
            return Object.assign(Object.assign({}, baseGrid), { pattern: 'GRID', sectionSize: grid.sectionSize || 8 });
        }
        else {
            return Object.assign(Object.assign({}, baseGrid), { pattern: grid.pattern, alignment: grid.alignment || 'STRETCH', gutterSize: grid.gutterSize || 20, count: grid.count || 12, offset: grid.offset || 0 });
        }
    });
    return {
        id: style.id,
...
async function updateColorStyle(payload) {
...
async function updateGridStyle(payload) {
...
async function setCurrentPage(payload) {
    let page;
    if (payload.pageId) {
...
async function createFrame(payload) {
    ...
    if (payload.width)
        frame.resize(payload.width, payload.height || 100);
    if (payload.x !== undefined)
        frame.x = payload.x;
    if (payload.y !== undefined)
        frame.y = payload.y;
    ...
    if (payload.autoLayout) {
        ...
        if (payload.autoLayout.itemSpacing !== undefined)
            frame.itemSpacing = payload.autoLayout.itemSpacing;
        if (payload.autoLayout.paddingTop !== undefined)
            frame.paddingTop = payload.autoLayout.paddingTop;
        if (payload.autoLayout.paddingRight !== undefined)
            frame.paddingRight = payload.autoLayout.paddingRight;
        if (payload.autoLayout.paddingBottom !== undefined)
            frame.paddingBottom = payload.autoLayout.paddingBottom;
        if (payload.autoLayout.paddingLeft !== undefined)
            frame.paddingLeft = payload.autoLayout.paddingLeft;
        if (payload.autoLayout.primaryAxisSizingMode)
            frame.primaryAxisSizingMode = payload.autoLayout.primaryAxisSizingMode;
        if (payload.autoLayout.counterAxisSizingMode)
            frame.counterAxisSizingMode = payload.autoLayout.counterAxisSizingMode;
    }
    // Also support legacy layoutMode/padding format
        ...
        if (payload.padding) {
            if (payload.padding.top !== undefined)
                frame.paddingTop = payload.padding.top;
            if (payload.padding.right !== undefined)
                frame.paddingRight = payload.padding.right;
            if (payload.padding.bottom !== undefined)
                frame.paddingBottom = payload.padding.bottom;
            if (payload.padding.left !== undefined)
                frame.paddingLeft = payload.padding.left;
        }
    }
...
async function updateText(payload) {
    ...
    const fontFamily = payload.fontFamily || textNode.fontName.family || 'Switzer';
    const fontStyle = payload.fontStyle || textNode.fontName.style || 'Regular';
    await figma.loadFontAsync({ family: fontFamily, style: fontStyle });
...
async function createRectangle(payload) {
    ...
    if (payload.y !== undefined)
        rect.y = payload.y;
    if (payload.fills)
        rect.fills = payload.fills;
    if (payload.cornerRadius !== undefined)
        rect.cornerRadius = payload.cornerRadius;
    if (payload.strokes)
        rect.strokes = payload.strokes;
    if (payload.strokeWeight !== undefined)
        rect.strokeWeight = payload.strokeWeight;
    return {
        id: rect.id,
        name: rect.name
    };
}
async function appendToFrame(payload) {
...
async function createComponent(payload) {
    ...
    if (payload.layoutMode && payload.layoutMode !== 'NONE') {
        ...
        if (payload.itemSpacing !== undefined)
            component.itemSpacing = payload.itemSpacing;
        if (payload.padding) {
            if (payload.padding.top !== undefined)
                component.paddingTop = payload.padding.top;
            if (payload.padding.right !== undefined)
                component.paddingRight = payload.padding.right;
            if (payload.padding.bottom !== undefined)
                component.paddingBottom = payload.padding.bottom;
            if (payload.padding.left !== undefined)
                component.paddingLeft = payload.padding.left;
        }
        if (payload.primaryAxisAlignItems)
            component.primaryAxisAlignItems = payload.primaryAxisAlignItems;
        if (payload.counterAxisAlignItems)
            component.counterAxisAlignItems = payload.counterAxisAlignItems;
        if (payload.primaryAxisSizingMode)
            component.primaryAxisSizingMode = payload.primaryAxisSizingMode;
        if (payload.counterAxisSizingMode)
            component.counterAxisSizingMode = payload.counterAxisSizingMode;
    }
    return {
        id: component.id,
        name: component.name,
...
async function bindVariable(payload) {
    var _a, _b;
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    ...
    if (payload.property === 'fills' && 'fills' in sceneNode) {
        ...
        const idx = (_a = payload.index) !== null && _a !== void 0 ? _a : 0;
        if (fills[idx] && fills[idx].type === 'SOLID') {
            const fill = Object.assign({}, fills[idx]);
        ...
        const idx = (_b = payload.index) !== null && _b !== void 0 ? _b : 0;
        if (strokes[idx] && strokes[idx].type === 'SOLID') {
            const stroke = Object.assign({}, strokes[idx]);
        ...
        sceneNode.setBoundVariable(payload.property, variable);
    }
    return {
        success: true,
        nodeId: node.id,
...
async function setComponentProperties(payload) {
    var _a, _b, _c;
    ...
    for (const prop of payload.properties) {
        if (prop.type === 'BOOLEAN') {
            component.addComponentProperty(prop.name, 'BOOLEAN', (_a = prop.defaultValue) !== null && _a !== void 0 ? _a : true);
        }
        else if (prop.type === 'TEXT') {
            component.addComponentProperty(prop.name, 'TEXT', (_b = prop.defaultValue) !== null && _b !== void 0 ? _b : '');
        }
        else if (prop.type === 'INSTANCE_SWAP') {
            component.addComponentProperty(prop.name, 'INSTANCE_SWAP', '');
        }
        else if (prop.type === 'VARIANT') {
            component.addComponentProperty(prop.name, 'VARIANT', (_c = prop.defaultValue) !== null && _c !== void 0 ? _c : '');
        }
    }
    return {
        success: true,
...
async function createEllipse(payload) {
    const ellipse = figma.createEllipse();
    if (payload.name)
        ellipse.name = payload.name;
    ...
    if (payload.y !== undefined)
        ellipse.y = payload.y;
    if (payload.fills)
        ellipse.fills = payload.fills;
    if (payload.strokes)
        ellipse.strokes = payload.strokes;
    if (payload.strokeWeight !== undefined)
...
async function createVector(payload) {
    const vector = figma.createVector();
    if (payload.name)
        vector.name = payload.name;
    if (payload.x !== undefined)
        vector.x = payload.x;
    if (payload.y !== undefined)
        vector.y = payload.y;
    ...
    if (payload.fills)
        vector.fills = payload.fills;
    if (payload.strokes)
        vector.strokes = payload.strokes;
    if (payload.strokeWeight !== undefined)
        vector.strokeWeight = payload.strokeWeight;
    if (payload.strokeCap)
        vector.strokeCap = payload.strokeCap;
    return {
        id: vector.id,
        name: vector.name
    };
...
async function createLine(payload) {
    ...
    if (payload.rotation !== undefined)
        line.rotation = payload.rotation;
    if (payload.strokes)
        line.strokes = payload.strokes;
    if (payload.strokeWeight !== undefined)
...
async function getVariables(payload) {
    const variables = await figma.variables.getLocalVariablesAsync();
...
async function getVarsDetailed(payload) {
    const collection = await figma.variables.getVariableCollectionByIdAsync(payload.collectionId);
    if (!collection) {
        throw new Error(`Collection not found: ${payload.collectionId}`);
    }
    ...
    return collectionVars.map(v => {
        ...
        for (const mode of collection.modes) {
            ...
            if (val && typeof val === 'object' && 'type' in val && val.type === 'VARIABLE_ALIAS') {
                valuesByMode[mode.modeId] = { type: 'VARIABLE_ALIAS', id: val.id };
            }
            else {
...
async function hideCollectionFromPublishing(payload) {
    const collection = await figma.variables.getVariableCollectionByIdAsync(payload.collectionId);
    if (!collection) {
        throw new Error(`Collection not found: ${payload.collectionId}`);
    }
...
async function renameCollection(payload) {
    const collection = await figma.variables.getVariableCollectionByIdAsync(payload.collectionId);
    if (!collection) {
        throw new Error(`Collection not found: ${payload.collectionId}`);
    }
...
async function deleteCollection(payload) {
    const collection = await figma.variables.getVariableCollectionByIdAsync(payload.collectionId);
    if (!collection) {
        throw new Error(`Collection not found: ${payload.collectionId}`);
    }
...
async function setExplicitVariableModes(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function getExplicitVariableModes(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function clearExplicitVariableModes(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function createModeSwitchingFrames(payload) {
        ...
        if (modeNames.includes('Desktop') && modeNames.includes('Mobile')) {
            ...
            if (desktopMode && mobileMode) {
                deviceCollections.push({
                    ...
                    tabletModeId: (tabletMode === null || tabletMode === void 0 ? void 0 : tabletMode.modeId) || desktopMode.modeId,
...
async function getPageChildren(payload) {
    let page;
    if (payload.pageId) {
...
async function moveNodeToPage(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function cloneNodeToPage(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function clearPageChildren(payload) {
    let page;
    if (payload.pageName) {
        page = figma.root.children.find(p => p.name === payload.pageName);
    }
    ...
    if (!page)
        throw new Error(`Page not found: ${payload.pageName || 'current'}`);
...
async function getNodeInfo(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function setNodePosition(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function appendNodeToFrame(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function resizeNode(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function createColorSwatchesGroup(payload) {
    const parent = await figma.getNodeByIdAsync(payload.parentFrameId);
    if (!parent)
        throw new Error(`Parent frame not found: ${payload.parentFrameId}`);
    // Group Frame
...
async function createTypographyGroup(payload) {
    const parent = await figma.getNodeByIdAsync(payload.parentFrameId);
    if (!parent)
        throw new Error(`Parent frame not found: ${payload.parentFrameId}`);
    // Group Frame
...
async function createEffectGroup(payload) {
    const parent = await figma.getNodeByIdAsync(payload.parentFrameId);
    if (!parent)
        throw new Error(`Parent frame not found: ${payload.parentFrameId}`);
    // Group Frame
...
async function createGridGroup(payload) {
    const parent = await figma.getNodeByIdAsync(payload.parentFrameId);
    if (!parent)
        throw new Error(`Parent frame not found: ${payload.parentFrameId}`);
    // Group Frame
...
async function setAutoLayout(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
    ...
    if (payload.paddingLeft !== undefined)
        frame.paddingLeft = payload.paddingLeft;
    if (payload.paddingRight !== undefined)
        frame.paddingRight = payload.paddingRight;
    if (payload.paddingTop !== undefined)
        frame.paddingTop = payload.paddingTop;
    if (payload.paddingBottom !== undefined)
...
async function bindVariableToNode(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
    ...
    switch (payload.field) {
        case 'fills':
            if ('fills' in sceneNode && Array.isArray(sceneNode.fills) && sceneNode.fills.length > 0) {
                ...
                const fillsCopy = figma.variables.setBoundVariableForPaint(sceneNode.fills[0], 'color', variable);
                sceneNode.fills = [fillsCopy];
            }
            break;
        case 'strokes':
            if ('strokes' in sceneNode && Array.isArray(sceneNode.strokes) && sceneNode.strokes.length > 0) {
                const strokesCopy = figma.variables.setBoundVariableForPaint(sceneNode.strokes[0], 'color', variable);
        ...
        case 'cornerRadius':
            if (payload.field in sceneNode) {
                sceneNode.setBoundVariable(payload.field, variable);
            }
            break;
    }
    return {
...
async function setNodeFills(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
    ...
    const newFills = payload.fills.map(f => {
        var _a;
        return ({
            type: 'SOLID',
            color: f.color,
...
async function addComponentDescription(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function importComponentByKey(payload) {
    try {
...
async function searchLibraryComponents(payload) {
    const results = [];
    try {
                        ...
                        if (matchesQuery) {
                            ...
                            if (!results.find(r => r.key === mainComp.key)) {
                                results.push({
                                    ...
                                    libraryName: ((_a = mainComp.parent) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown Library'
                                });
                            }
                        }
                    }
...
async function flattenNode(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
...
async function convertToComponent(payload) {
    const node = await figma.getNodeByIdAsync(payload.nodeId);
    if (!node) {
        throw new Error(`Node not found: ${payload.nodeId}`);
    }
    ...
    if ('fills' in sceneNode) {
        component.fills = sceneNode.fills;
    }
    if ('strokes' in sceneNode) {
        component.strokes = sceneNode.strokes;
    }
...
async function setInstanceSwapProperty(payload) {
    const component = await figma.getNodeByIdAsync(payload.componentId);
    if (!component || (component.type !== 'COMPONENT' && component.type !== 'COMPONENT_SET')) {
        throw new Error(`Component not found: ${payload.componentId}`);
    }
    // Add instance swap property
    component.addComponentProperty(payload.propertyName, 'INSTANCE_SWAP', '' // Default value is empty (will use current instance)
    );
    return { success: true };
}
async function swapInstance(payload) {
...
async function batchImportAndFlatten(payload) {
    var _a, _b, _c, _d;
    const icons = [];
    const errors = [];
    let currentX = (_a = payload.x) !== null && _a !== void 0 ? _a : 0;
    let currentY = (_b = payload.y) !== null && _b !== void 0 ? _b : 0;
    const spacing = (_c = payload.spacing) !== null && _c !== void 0 ? _c : 40;
    // Find the variable to bind if specified
    let strokeVariable = null;
        ...
        try {
            ...
            if (strokeVariable && 'strokes' in flattened && Array.isArray(flattened.strokes) && flattened.strokes.length > 0) {
                ...
                if (strokes[0] && strokes[0].type === 'SOLID') {
                    const boundStroke = figma.variables.setBoundVariableForPaint(strokes[0], 'color', strokeVariable);
                    flattened.strokes = [boundStroke];
                }
            }
            let finalNode = flattened;
            ...
            if (icons.length % 10 === 0) {
                currentX = (_d = payload.x) !== null && _d !== void 0 ? _d : 0;
                currentY += spacing;
            }
        }
        catch (e) {
...
async function createFromSvg(payload) {
...
async function batchCreateIconsFromSvg(payload) {
    var _a, _b, _c, _d, _e;
    const icons = [];
    const errors = [];
    const spacing = (_a = payload.spacing) !== null && _a !== void 0 ? _a : 40;
    const iconsPerRow = (_b = payload.iconsPerRow) !== null && _b !== void 0 ? _b : 10;
    let currentX = (_c = payload.x) !== null && _c !== void 0 ? _c : 0;
    let currentY = (_d = payload.y) !== null && _d !== void 0 ? _d : 0;
    ...
    for (let i = 0; i < payload.icons.length; i++) {
        ...
        try {
            ...
            if ((i + 1) % iconsPerRow === 0) {
                currentX = (_e = payload.x) !== null && _e !== void 0 ? _e : 0;
                currentY += spacing;
            }
        }
        catch (e) {
...
async function cloneAndConvertIcon(payload) {
    ...
    // Find target page
    const targetPage = figma.root.children.find(p => p.name === payload.targetPageName ||
    ...
    targetPage.appendChild(cloned);
    // Position
    cloned.x = (_a = payload.x) !== null && _a !== void 0 ? _a : 0;
    cloned.y = (_b = payload.y) !== null && _b !== void 0 ? _b : 0;
    ...
    if (cloned.type === 'INSTANCE') {
        ...
        flattened.x = (_c = payload.x) !== null && _c !== void 0 ? _c : 0;
        flattened.y = (_d = payload.y) !== null && _d !== void 0 ? _d : 0;
        // Bind stroke to variable if specified
        if (payload.bindStrokeVariable) {
            ...
            if ('fills' in flattened && Array.isArray(flattened.fills) && flattened.fills.length > 0) {
                ...
                if (fills[0] && fills[0].type === 'SOLID') {
                    const boundFill = figma.variables.setBoundVariableForPaint(fills[0], 'color', strokeVariable);
                    flattened.fills = [boundFill];
                }
            }
        }
        ...
        component.x = (_e = payload.x) !== null && _e !== void 0 ? _e : 0;
        component.y = (_f = payload.y) !== null && _f !== void 0 ? _f : 0;
    ...
    component.x = (_g = payload.x) !== null && _g !== void 0 ? _g : 0;
    component.y = (_h = payload.y) !== null && _h !== void 0 ? _h : 0;
    component.appendChild(flattened);
    flattened.x = 0;
    flattened.y = 0;
    return {
...
async function processTempIcons(payload) {
    var _a, _b;
    const icons = [];
    const errors = [];
    ...
    let currentX = (_a = payload.startX) !== null && _a !== void 0 ? _a : 100;
    let currentY = (_b = payload.startY) !== null && _b !== void 0 ? _b : 100;
    const startX = currentX;
    // Find target page - be specific to avoid matching wrong pages
    const targetPage = figma.root.children.find(p => p.name === targetPageName ||
        p.name === '🎯 Icons' ||
...
async function batchMoveToPage(payload) {
    var _a, _b;
    const errors = [];
    let moved = 0;
    const targetPage = figma.root.children.find(p => p.id === payload.targetPageId);
...
async function scanPageInstances(payload) {
    let page;
    if (payload.pageId) {
        const foundPage = figma.root.children.find(p => p.id === payload.pageId);
        if (!foundPage) {
    ...
    function findInstances(node) {
        if (node.type === 'INSTANCE') {
            ...
            instances.push({
                id: instance.id,
                name: instance.name,
                mainComponentName: (mainComp === null || mainComp === void 0 ? void 0 : mainComp.name) || null,
                mainComponentKey: (mainComp === null || mainComp === void 0 ? void 0 : mainComp.key) || null,
                isRemote,
                x: instance.x,
                y: instance.y,
...
async function flattenAndRenameInstances(payload) {
    var _a, _b;
    const icons = [];
    const errors = [];
    ...
    let currentX = (_a = payload.startX) !== null && _a !== void 0 ? _a : 100;
    let currentY = (_b = payload.startY) !== null && _b !== void 0 ? _b : 600;
    const startX = currentX;
    // Get target page
...
async function getFrameChildren(payload) {
...
async function extractTempIcons(payload) {
    ...
    function matchesTarget(variantName, filled) {
    ...
    for (const categoryFrame of sourcePage.children) {
        ...
        for (const iconSet of categoryFrame.children) {
            ...
            for (const variant of iconSet.children) {
                ...
                if (matchesTarget(variantName, false)) {
                    if (dryRun) {
                        ...
                        try {
                            const result = await createFlatIconFrame(variant, primaryName, iconsContainer || targetPage, strokeVariable);
                            icons.push({
                                id: result.id,
                                name: result.name,
                                sourceId: variant.id,
                ...
                if (matchesTarget(variantName, true)) {
                    ...
                    if (dryRun) {
                        ...
                        try {
                            const result = await createFlatIconFrame(variant, filledName, iconsContainer || targetPage, strokeVariable);
                            icons.push({
                                id: result.id,
                                name: result.name,
                                sourceId: variant.id,
        ...
        if (categoryIconCount > 0) {
            categories.push({
                ...
                frameId: categoryFrameNode === null || categoryFrameNode === void 0 ? void 0 : categoryFrameNode.id
            });
...
async function createFlatIconFrame(sourceNode, frameName, targetContainer, strokeVariable) {
    ...
    if (cloned.children.length > 0) {
        ...
        const childrenToFlatten = [...cloned.children];
...
async function getCategoryList(payload) {
    ...
    for (const categoryFrame of sourcePage.children) {
        ...
        let iconSetCount = 0;
        for (const child of categoryFrame.children) {
...
// ============================================================================
async function extractSingleCategory(payload) {
    ...
    for (const iconSet of sourceCategoryFrame.children) {
        ...
        for (const variant of iconSet.children) {
            ...
            if (matchesTarget(variantName, false)) {
                try {
                    const result = await createFlatIconFrame(variant, primaryName, iconsContainer, strokeVariable);
                    icons.push({
                        id: result.id,
                        name: result.name,
                        sourceId: variant.id,
            ...
            if (matchesTarget(variantName, true)) {
                const filledName = `${primaryName}_filled`;
                try {
                    const result = await createFlatIconFrame(variant, filledName, iconsContainer, strokeVariable);
                    icons.push({
                        id: result.id,
                        name: result.name,
                        sourceId: variant.id,
...
async function analyzePageStyles(payload) {
    ...
    async function analyzeNode(node) {
        ...
        if ('fills' in node && Array.isArray(node.fills)) {
            ...
            if (hasFillStyleId && typeof node.fillStyleId === 'string') {
                ...
                fillStyleName = style === null || style === void 0 ? void 0 : style.name;
            }
        ...
        if ('effects' in node && Array.isArray(node.effects)) {
            ...
            if (hasEffectStyleId && typeof node.effectStyleId === 'string') {
                ...
                effectStyleName = style === null || style === void 0 ? void 0 : style.name;
            }
        ...
        if (node.type === 'TEXT') {
            ...
            if (hasTextStyleId && typeof node.textStyleId === 'string') {
                ...
                textStyleName = style === null || style === void 0 ? void 0 : style.name;
            }
            ...
            if (fontName && typeof fontName !== 'symbol' && typeof fontSize === 'number') {
                ...
                textStyles.set(key, Object.assign(Object.assign({}, existing), { count: existing.count + 1, hasStyleId: existing.hasStyleId || hasTextStyleId, styleName: textStyleName || existing.styleName }));
            }
        }
    ...
    const fillsArray = Array.from(fills.entries())
        .map(([color, data]) => (Object.assign({ color }, data)))
    ...
    const variableBindingsArray = Array.from(variableBindings.entries())
        .map(([key, data]) => (Object.assign({ variableName: key.split('|')[0] }, data)))
        .sort((a, b) => b.count - a.count);
    return {
        fills: fillsArray,
...
async function remapEffectStyles(payload) {
...
async function batchCreateVariables(payload) {
...
async function batchSetVariableAliases(payload) {
    var setCount = 0;
    var errors = [];
...
async function batchCreateStyles(payload) {
    var textStyleIds = {};
    var effectStyleIds = {};
    var errors = [];
    var textCount = 0;
