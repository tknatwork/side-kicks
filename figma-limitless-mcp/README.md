...
Total surface: **72 tools**, including the ~30 upstream read/write tools
(document/selection/node/styles/variables reads, screenshots,
text/fill/effect/stroke/auto-layout patches, frame/text/shape/image creation,
duplicate/reparent/group, guarded delete).
